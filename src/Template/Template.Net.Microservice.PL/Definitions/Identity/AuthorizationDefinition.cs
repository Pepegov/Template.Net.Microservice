...
using Template.Net.Microservice.PL.Definitions.Identity.Options;
using Template.Net.Microservice.PL.Definitions.OpenIddict;

namespace Template.Net.Microservice.PL.Definitions.Identity;
